...
class salesClass:
    def __init__(self, root):
        ...
        lbl_title=Label(self.root, text="View Customer Bill", font=("Times new roman", 25), bg="#184a45", fg="#fff", bd=3, relief=RIDGE)
        ...
        txt_invoice=Entry(self.root,textvariable=self.var_invoice,font=("times new roman" ,15),bg="lightblue")
        ...
        self.Sales_List=Listbox(sales_frame,font=("goudy old style",10),bg="white",yscrollcommand=scrolly.set)
        ...
        lbl_title2=Label(bill_frame, text="Customer Bill Area", font=("Times new roman", 20), bg="#184a45", fg="#fff", bd=3, relief=RIDGE)
        lbl_title2.pack(side=TOP, fill=X)
        
        
        scrolly2=Scrollbar(bill_frame,orient=VERTICAL)
        
        self.bill_area=Text(bill_frame,bg="cyan", yscrollcommand=scrolly2.set)
    ...
    def search(self):
        if self.var_invoice.get()=="":
            ...
            if self.var_invoice.get() in self.bill_list:
                ...
                messagebox.showerror("Error","Inaalid Invoice No",parent=self.root)
    def clear(self):
        self.show()
        self.bill_area.delete('1.0',END)
